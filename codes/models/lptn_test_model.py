...
class LPTNTestModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if load_path is not None:
            self.load_network(self.net_g, self.opt['path']['root']+load_path,
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            # self.output,self.mask = self.net_g(self.lq) # hmmznn
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if save_img:
                ...
                if 'mask' in visuals: #hmmznn
                    plot_img = np.hstack((plot_img, mask_img))
                if 'gt' in visuals:
    ...
    def get_current_visuals(self):
        ...
        # out_dict['mask'] = self.mask.detach().cpu() #hmmznn
        if hasattr(self, 'gt'):
